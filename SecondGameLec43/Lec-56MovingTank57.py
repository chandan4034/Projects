...
def tank(x,y):
    ...
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[0],turrentWidth)
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[1],turrentWidth)
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[2],turrentWidth)
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[3],turrentWidth)
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[4],turrentWidth)
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[5],turrentWidth)
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[6],turrentWidth)
    pygame.draw.line(gameDisplay,black,(x,y),possibleTurrets[7],turrentWidth)

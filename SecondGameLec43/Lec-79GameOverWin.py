...
fire_sound = pygame.mixer.Sound("cello.wav")
explosion_sound = pygame.mixer.Sound("bass.wav")
#For Infinite Looping
    # pygame.mixer.music.load("bass.wav")
    # pygame.mixer.music.play(-1)
#End of Infinite looping
...
def fireShell(xy,tankx,tanky,turPos,gun_power,xlocation,barrier_width,
    ...
    while fire:
        ...
        if startingShell[1] > display_height - ground_height:
            ...
            #print("Enemy: ",enemyTankX,enemyTankY,"HitX: ",hit_x)
            if enemyTankX + 15 > hit_x > enemyTankX - 35:
                damage = 25
            fire = False
...
def e_fireShell(xy,tankx,tanky,turPos,gun_power,xlocation,barrier_width,randomHeight,ptankX,ptankY):
    ...
    while fire:
        ...
        pygame.draw.circle(gameDisplay,green,(startingShell[0],startingShell[1]),5)
        #Just making an arc by adjusting quadratic equation
        gunPower = random.randrange((int(currentPower*0.8)),(int(currentPower*1.1)))
        startingShell[0] += (12 - turPos) * 2
...
def health_bars(player_health,enemy_health):
    ...
    pygame.draw.rect(gameDisplay,player_health_color,(680,25,player_health,20))
    pygame.draw.rect(gameDisplay,enemy_health_color,(20,25,enemy_health,20))
def gameLoop():
    gameExit = False
    gameOver = False
    ...
    power_change = 0
    fire_power = 50
    player_health = 100 #Initially
    enemy_health = 100 #Initially
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_LEFT:
                    ...
                    for x in range(random.randrange(0,10)):
                        print(display_width*0.3,enemyTankX)

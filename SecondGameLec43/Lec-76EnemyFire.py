...
def health_bars(player_health,enemy_health):
    ...
    pygame.draw.rect(gameDisplay,player_health_color,(730,25,50,20))
    pygame.draw.rect(gameDisplay,enemy_health_color,(20,25,50,20))
def gameLoop():
    gameExit = False
    gameOver = False
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_LEFT:
                    ...
                    e_fireShell(enemy_gun,enemyTankX,enemyTankY,8,50,
